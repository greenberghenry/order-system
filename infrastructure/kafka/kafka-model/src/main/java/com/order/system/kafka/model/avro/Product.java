...
public class Product extends org.apache.avro.specific.SpecificRecordBase
  ...
  private static final long serialVersionUID = -4616185635941712402L;

  public static final org.apache.avro.Schema SCHEMA$ =
      new org.apache.avro.Schema.Parser()
          .parse(
              "{\"type\":\"record\",\"name\":\"Product\",\"namespace\":\"com.order.system.kafka.model.avro\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"quantity\",\"type\":\"int\"}]}");
   ...
   */
  public static com.order.system.kafka.model.avro.Product.Builder newBuilder() {
    return new com.order.system.kafka.model.avro.Product.Builder();
  }
   ...
   */
  public static com.order.system.kafka.model.avro.Product.Builder newBuilder(
      com.order.system.kafka.model.avro.Product.Builder other) {
    if (other == null) {
      return new com.order.system.kafka.model.avro.Product.Builder();
    } else {
      return new com.order.system.kafka.model.avro.Product.Builder(other);
    }
  }
   ...
   */
  public static com.order.system.kafka.model.avro.Product.Builder newBuilder(
      com.order.system.kafka.model.avro.Product other) {
    if (other == null) {
      return new com.order.system.kafka.model.avro.Product.Builder();
    } else {
      return new com.order.system.kafka.model.avro.Product.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.order.system.kafka.model.avro.Product.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.order.system.kafka.model.avro.Product other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
     ...
     * @return This builder.
     */
    public com.order.system.kafka.model.avro.Product.Builder setId(java.util.UUID value) {
     ...
     * @return This builder.
     */
    public com.order.system.kafka.model.avro.Product.Builder clearId() {
      id = null;
     ...
     * @return This builder.
     */
    public com.order.system.kafka.model.avro.Product.Builder setQuantity(int value) {
     ...
     * @return This builder.
     */
    public com.order.system.kafka.model.avro.Product.Builder clearQuantity() {
